...
:Version: Draft
:Authors: fishman-ctags develoeprs
:Web Page: https://github.com/fishman/ctags

Introduction
======================================================================
fishman-ctags is a project/git repository/command forked from
exuberant-ctags. The project is hosted at github. fishman-ctags
repository is started by Reza Jelveh <reza.jelveh@gmail.com>.
