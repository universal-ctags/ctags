...
#. name in "name:value" of tagfield in tags file generated by
   Universal ctags may contain spaces when ``--fields=+s`` option is
   passed to ctags to generate scope information.
