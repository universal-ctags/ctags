...
* The value may be empty.
  ...
  - The characters in range 0x01 to 0x1F included, and 0x7F are converted
    to \x prefixed hexadecimal number if the characters are not handled
    in the above "value" rules.
  - A leading "\\ " stands for a space (' ', 0x20).
  - A leading "\\!" stands for an exclamation mark ('!', 0x21).
