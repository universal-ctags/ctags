...
static optionDescription LongOptionDescription [] = {
...
#endif
 {1,"  --kinddef-<LANG>=<letter>,<name>,<description>"},
 {1,"       Define new kind for <LANG>."},
 {1,"  --kinds-(<LANG>|all)=[+|-](<kinds>|*)"},
 ...
 {1,"       e.g. --langmap=c:.c.x,java:+.j,make:([Mm]akefile).mak"},
 {1,"  --language-force=(<language>|auto)"},
 {1,"       Force all files to be interpreted using specified <language>."},
 {1,"  --languages=[+|-](<list>|all)"},
 ...
 {1,"       Output list of all roles of tag kind(s) specified for <language>."},
 ...
 {1,"  --options-maybe=<pathname>"},
 {1,"       Do the same as --options but this doesn't make an error for non-existing file."},
 {1,"  --optlib-dir=[+]<directory>"},
 {1,"       Add or set <directory> to optlib search path."},
#ifdef HAVE_ICONV
...
#endif
#ifdef HAVE_JANSSON
 {0,"  --output-format=(u-ctags|e-ctags|etags|xref|json)"},
#else
 ...
 {0,"       input file."},
 {0,"  --pseudo-tags=[+|-](<pseudo-tag>|*)"},
 {0,"       Enable/disable emitting pseudo tag named <pseudo-tag>."},
...
static optionDescription ExperimentalLongOptionDescription [] = {
 ...
 {1,"  --_roledef-<LANG>.<kind>=<name>,<description>"},
