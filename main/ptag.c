...
static ptagDesc ptagDescs [] = {
	{
	  ...
	  "version of json output stream format",
	  ptagMakeJsonOutputVersion,
	  TRUE },
	{ TRUE, "TAG_FILE_FORMAT",
	  "version of tags file format",
	  ptagMakeFormat,
	  TRUE },
	...
	{ TRUE, "TAG_PROGRAM_AUTHOR",
	  "author of this ctags implementation",
	  ptagMakeAuthor,
	  TRUE },
	{ TRUE, "TAG_PROGRAM_NAME",
	  "name of this ctags implementation",
	  ptagMakeProgName,
	  TRUE },
	{ TRUE, "TAG_PROGRAM_URL",
	  "official site URL of this ctags implementation",
	  ptagMakeProgURL,
	  TRUE },
	{ TRUE, "TAG_PROGRAM_VERSION",
	  "version of this ctags implementation",
	  ptagMakeProgVersion,
	  TRUE },
#ifdef HAVE_ICONV
	{ TRUE, "TAG_FILE_ENCODING",
	  "encoding used in output tags file",
	  ptagMakeFileEncoding,
	  TRUE },
#endif
	{ FALSE, "TAG_KIND_SEPARATOR",
	  "separators used in kinds",
	  ptagMakeKindSeparators,
	  FALSE },
	{ FALSE, "TAG_KIND_DESCRIPTION",
	  "letters, names and descriptions of kinds in a parser",
