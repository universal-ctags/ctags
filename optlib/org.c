/*
 * Generated by /home/pac/ZONE/PKG/TAGS/UNIVERSAL_CTAGS/ctags/misc/optlib2c from /home/pac/ZONE/PKG/TAGS/UNIVERSAL_CTAGS/ctags/optlib/org.ctags, Don't edit this manually.
 */
#include "general.h"
#include "parse.h"
#include "routines.h"
...
static void initializeOrgParser (const langType language)
{
	...
	addLanguageTagMultiTableRegex (language, "toplevel",
	                               "^\\*\\*\\*\\*\\*\\*\\*[ \t]+([[:graph:][:blank:]]+)([\n])?",
	                               "\\1", "G,subparagraph", "", NULL);
	addLanguageTagMultiTableRegex (language, "toplevel",
	                               "^\\*\\*\\*\\*\\*\\*[ \t]+([[:graph:][:blank:]]+)([\n])?",
	                               "\\1", "P,paragraph", "", NULL);
	addLanguageTagMultiTableRegex (language, "toplevel",
	                               "^\\*\\*\\*\\*\\*[ \t]+([[:graph:][:blank:]]+)([\n])?",
	                               "\\1", "b,subsubsection", "", NULL);
	addLanguageTagMultiTableRegex (language, "toplevel",
	                               "^\\*\\*\\*\\*[ \t]+([[:graph:][:blank:]]+)([\n])?",
	                               "\\1", "u,subsection", "", NULL);
	addLanguageTagMultiTableRegex (language, "toplevel",
