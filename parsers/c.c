...
typedef enum eKeywordId {
	KEYWORD_NONE = -1,
	KEYWORD_ABSTRACT, KEYWORD_ALIAS, KEYWORD_ALIGN, KEYWORD_ASM,
	KEYWORD_ASSERT, KEYWORD_ATTRIBUTE, KEYWORD_AUTO,
	...
	KEYWORD_CENT, KEYWORD_CFLOAT, KEYWORD_CHAR, KEYWORD_CLASS,
	KEYWORD_CONST, KEYWORD_CONSTRAINT, KEYWORD_CONTINUE,
	KEYWORD_COVERAGE_BLOCK, KEYWORD_COVERAGE_DEF, KEYWORD_CREAL,
	KEYWORD_DCHAR, KEYWORD_DEBUG, KEYWORD_DEFAULT, KEYWORD_DELEGATE,
	KEYWORD_DELETE, KEYWORD_DEPRECATED, KEYWORD_DO, KEYWORD_DOUBLE,
	KEYWORD_ELSE, KEYWORD_ENUM, KEYWORD_EVENT,
	KEYWORD_EXPLICIT, KEYWORD_EXPORT, KEYWORD_EXTENDS,
	KEYWORD_EXTERN,
	KEYWORD_FALSE, KEYWORD_FINAL, KEYWORD_FINALLY, KEYWORD_FLOAT,
	KEYWORD_FOR, KEYWORD_FOREACH, KEYWORD_FOREACH_REVERSE,
	KEYWORD_FRIEND, KEYWORD_FUNCTION,
	KEYWORD_GOTO,
	KEYWORD_IDOUBLE, KEYWORD_IF, KEYWORD_IFLOAT, KEYWORD_IMPLEMENTS,
	KEYWORD_IMPORT, KEYWORD_IN, KEYWORD_INLINE, KEYWORD_INOUT,
	KEYWORD_INPUT, KEYWORD_INT, KEYWORD_INTEGER, KEYWORD_INTERFACE,
	KEYWORD_INTERNAL, KEYWORD_INVARIANT, KEYWORD_IREAL, KEYWORD_IS,
	KEYWORD_LAZY, KEYWORD_LOCAL, KEYWORD_LONG,
	...
	KEYWORD_NULL,
	KEYWORD_OPERATOR, KEYWORD_OUT, KEYWORD_OUTPUT, KEYWORD_OVERLOAD,
	KEYWORD_OVERRIDE,
	KEYWORD_PACKAGE, KEYWORD_PACKED, KEYWORD_PORT,
	KEYWORD_PRAGMA, KEYWORD_PRIVATE, KEYWORD_PROGRAM,
	KEYWORD_PROTECTED, KEYWORD_PUBLIC,
	KEYWORD_REAL, KEYWORD_REGISTER, KEYWORD_RETURN,
	KEYWORD_SCOPE, KEYWORD_SHADOW, KEYWORD_SHORT, KEYWORD_SIGNED,
	KEYWORD_STATE, KEYWORD_STATIC, KEYWORD_STRING, KEYWORD_STRUCT,
	KEYWORD_SUPER, KEYWORD_SWITCH, KEYWORD_SYNCHRONIZED,
	...
	KEYWORD_UNION, KEYWORD_UNITTEST, KEYWORD_UNSIGNED,
